...
class ResNetV2(nn.Module):
    ...
    def __init__(self, block_units, width_factor, head_size=21843, zero_head=False, use_thresh=False,
                 thresh=1e6):
        super().__init__()
    ...
    def forward(self, x, layer_index=None):
        ...
        if self.use_thresh:
            # print("I am using thresh", self.thresh)
            return self.forward_thresh(x, thresh=self.thresh)
    ...
    def forward_thresh(self, x, thresh=1e6):
